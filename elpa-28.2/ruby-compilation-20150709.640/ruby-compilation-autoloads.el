;;; ruby-compilation-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
Run the current buffer through Ruby compilation." t nil)

(autoload 'pcomplete/rake "ruby-compilation" "\
Start pcompletion using the list of available rake tasks." nil nil)

(autoload 'ruby-compilation-rake-refresh-tasks "ruby-compilation" "\
Reset the list of available rake tasks for the current Rakefile environment." t nil)
...
Start pcompletion using the list of available capistrano tasks." nil nil)
...
Run the test at point through Ruby compilation." t nil)
