;;; cl-libify-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
Make all the `cl' vars and functions obsolete so that byte compilation will flag their use." t nil)

(register-definition-prefixes "cl-libify" '("cl-libify-"))

;;;***

;;;### (autoloads nil nil ("cl-libify-pkg.el") (0 0 0 0))
